    ...
    <div className="flex-none hidden lg:block  bg-black h-screen min-w-[25%] fixed ">
      ...
      >
        ...
        <div
          title="Instagram"
          onClick={() =>
            window.open("https://www.instagram.com/mohitmahajan", "_blank")
          }
        >
          {" "}
        ...
        <div
          ...
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/Mohit-Mahajan-k-a727a822a",
              "_blank"
            )
          }
        >
        ...
        <div
          title="Facebook"
          onClick={() =>
            window.open("https://www.facebook.com/mohitmahajan", "_blank")
          }
        >
