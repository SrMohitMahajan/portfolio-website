      ...
      <div className="flex flex-row flex-wrap gap-6" style={{padding:'35px'}}>
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3
            ...
            data-aos={"fade-left"}
          >
            I'm <span className="text-yellow-600">Mohit Mahajan,</span> a Web
            Enthusiast
          </h3>
          <p
            ...
            data-aos={"fade-left"}
          >
            I have a Bachelor's and Master's degree in Engineering, with over
            2 years of experience as a React.js Developer. I began my career at
            ITInformatix Pvt Ltd in 2020, where I currently work as a Senior
            React.js Developer, contributing to various projects successfully.
          </p>
          <p
