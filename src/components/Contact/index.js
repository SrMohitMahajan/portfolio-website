          ...
          <div data-aos={"slide-up"} className="text-center mt-10">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              {/* <div
                title="Github"
                onClick={() =>
                  window.open("https://github.com/Mohit-Mahajan", "_blank")
                }
              >
              ...
              <div
                ...
                onClick={() =>
                  window.open(
                    "https://www.instagram.com/mohitmahajan",
                    "_blank"
                  )
                }
              >
              ...
              <div
                ...
                onClick={() =>
                  window.open(
                    "https://in.linkedin.com/in/mohit-mahajan-06968a96?trk=public_profile_browsemap",
                    "_blank"
                  )
                }
              >
              ...
              {/* <div
                ...
                onClick={() =>
                  window.open(
                    "https://www.facebook.com/mohitmahajan",
                    "_blank"
                  )
                }
              >
